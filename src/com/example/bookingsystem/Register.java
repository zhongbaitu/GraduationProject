...
public class Register extends Activity {
	...
	private void init() {
		...
		registerCheckPassword = (EditText) this
				.findViewById(R.id.register_check_password);
		registerSureButton = (Button) this
				.findViewById(R.id.register_sure_button);
		...
		registerSureButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (usernameString.equals("")) {
					Toast.makeText(Register.this, "帐号不能为空", Toast.LENGTH_SHORT)
							.show();
	...
	private void responesDo(JSONObject jsonObject) {
		try {
			if (jsonObject.getString("result").equals("OK")) {
				...
				startActivity(new Intent(Register.this, MainPager.class));
				// 把 Guide 关掉
				Guide.guide.finish();
				finish();
			} else {
				Toast.makeText(Register.this, "系统异常", Toast.LENGTH_SHORT)
						.show();
			}
		} catch (JSONException e) {
			// TODO Auto-generated catch block

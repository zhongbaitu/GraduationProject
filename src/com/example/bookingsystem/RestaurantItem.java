...
public class RestaurantItem extends Activity {
	...
	private void init(){
		...
		restaurantName=(TextView) this.findViewById(R.id.restaurant_item_name);
		...
		ArrayAdapter foodAdapter=new ArrayAdapter(this,android.R.layout.simple_list_item_1,takeFoodList());
